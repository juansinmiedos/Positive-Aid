                ...
                <div className="container">
                    <div className="columns">
                        <div className="column is-one-quarter">
                            ...
                            <p className="subtitle">No necesitas crear una cuenta para conocer +.<br /><br />Accede a nuestras páginas públicas para informarte + acerca del VIH.</p>
                        </div>
                                ...
                                <div className="tile is-vertical is-4 cardd">
                                    <div className="tile">
                                        <div className="tile is-parent is-vertical">
                                            ...
                                            <article className="tile is-child notification is-danger">
                                                <p className="title">VIH y drogas</p>
