                                ...
                                <div className="column is-three-quarters">
                                    <div className="columns is-vcentered">
                                        <div className="column is-one-quarter is-right">
                                                <img src={context.state.user.profilePhoto} alt="placeholder"/>
                                        </div>
                                        <div className="column is-three-quarters">
                                            <h1 className="subtitle profile-header-text">{context.state.user.name} {context.state.user.lastname}</h1>
                                            <h1 className="title profile-header-text"><i className="fa fa-user"></i>  {context.state.user.username}</h1>
                                            <p className="subtitle profile-header-text">Status actual: {context.state.user.status}</p>
                                                    ...
                                                    <section className="modal-card-body">
                                                        <form onSubmit={this.submitEditForm}>
                                                                ...
                                                                <div className="field-body">
                                                                    <div className="field">
                                                                        <div className="control">
                                                                            <input onChange={this.handleInput} className="input" name="name" type="text" placeholder="Luis" value={context.state.user.name} />
                                                                        </div>
                                                                    </div>
                                                                    <div className="field">
                                                                        <div className="control">
                                                                            <input onChange={this.handleInput} className="input" name="lastname" type="text" placeholder="Pérez" value={context.state.user.lastname} />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div className="field is-hidden">
                                                                ...
                                                                <div className="control has-icons-left has-icons-right">
                                                                    <input onChange={this.handleInput} className="input" name="_id" type="text" placeholder="LP-1992" required value={context.state.user._id} />
                                                                    <span className="icon is-small is-left">
                                                                        <i className="fas fa-user"></i>
                                                                    </span>
                                                                </div>
